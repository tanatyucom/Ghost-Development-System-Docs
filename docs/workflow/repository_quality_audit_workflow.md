...
Repository Quality Audit の結果を Platform Execution Evidence として扱う場合は、
`docs/architecture/repository_quality_gate_evidence_specialization.md` に従います。
このspecializationでは、Repository Quality Reportを人間向け表示、Repository
Quality Gate Evidenceをplatform判断用の記録として分離します。
