...
| Ghost Platform Three Pillars | Architecture | Standard | ADR-GDS-001 / Platform Governance Q | 2026-07-16 | 2026-07-16 | `docs/rules/platform_governance_rules.md` | `docs/workflow/architecture_promotion_lifecycle.md` | `templates/decision_template.md` | `docs/requests/gds/draft/GDS-PLATFORM-GOVERNANCE-001_platform_governance_and_experimental_development/completion_report.md` | GDS, GameGhost, AnimeGhost, ComicGhost, Future Ghost | Defines Metadata False Positive Initiative, Repository Intelligence Foundation, and Repository Knowledge Integrity Initiative as separate pillars. Runtime implementation and SDK completion are not implied. | Review when Repository Intelligence or Knowledge Integrity moves to promotion review. |
| Repository Component Templates | Architecture | Standard | ADR-GDS-002 / Platform Governance Q | 2026-07-16 | 2026-07-16 | `docs/rules/platform_governance_rules.md` | `docs/workflow/architecture_promotion_lifecycle.md` | `templates/decision_template.md` | `docs/requests/gds/draft/GDS-PLATFORM-GOVERNANCE-001_platform_governance_and_experimental_development/completion_report.md` | GDS, GameGhost, AnimeGhost, ComicGhost, Future Ghost | Defines Engine, Core, Adapter, Center, Registry, Contract, and Dashboard as reusable component categories without requiring every feature to use every category. | Review when component templates or SDK requirements are drafted. |
| Canonical Knowledge Ownership | Architecture | Standard | ADR-GDS-003 / Platform Governance Q | 2026-07-16 | 2026-07-16 | `docs/rules/platform_governance_rules.md` | `docs/workflow/architecture_promotion_lifecycle.md` | `templates/decision_template.md` | `docs/requests/gds/draft/GDS-PLATFORM-GOVERNANCE-001_platform_governance_and_experimental_development/completion_report.md` | GDS, GameGhost, AnimeGhost, ComicGhost, Future Ghost | Canonical development knowledge belongs to GDS; generated execution artifacts belong to the repository where work was performed. Bulk migration requires a separate audited plan. | Review before any Ghost-local rule or roadmap migration Q. |
| Temporary Assembly Principle | Architecture | Standard | Platform Governance Q | 2026-07-16 | 2026-07-16 | `docs/rules/platform_governance_rules.md` | `docs/workflow/architecture_promotion_lifecycle.md` | `templates/decision_template.md` | `docs/requests/gds/draft/GDS-PLATFORM-GOVERNANCE-001_platform_governance_and_experimental_development/completion_report.md` | GDS, GameGhost, AnimeGhost, ComicGhost, Future Ghost | Defines safe, observable, recoverable experimentation for uncertain design areas. It is not careless prototyping or production mutation approval. | Review after first completed Temporary Assembly template or example. |
| Core + Adapter Experimental Pattern | Architecture | Standard | Platform Governance Q | 2026-07-16 | 2026-07-16 | `docs/rules/platform_governance_rules.md` | `docs/workflow/architecture_promotion_lifecycle.md` | `templates/decision_template.md` | `docs/requests/gds/draft/GDS-PLATFORM-GOVERNANCE-001_platform_governance_and_experimental_development/completion_report.md` | GDS, GameGhost, AnimeGhost, ComicGhost, Future Ghost | Recommends Core + Adapter when evidence supports a reusable boundary. It is not mandatory and does not imply SDK completion. | Review when Identity Engine or OCR Core + Adapter work is proposed. |
