...
| CASE-0008 | Steam OCR Root Cause Investigation: Candidate Generation Was the Real Bug | Steam | OCR, Debug, Investigation | Evidence Driven Development, First Broken Step, Pipeline Trace, Candidate Generation, Negative Knowledge | P0 | Human Approval Pending | Debug Escalation Ladder, First Broken Step Methodology |
